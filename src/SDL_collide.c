...
*/
int
SDL_CollidePixel(SDL_Surface* as, int ax, int ay, SDL_Surface* bs, int bx, int by)
{
  /*Box A;
  Box B;*/
...
*/
int
SDL_CollideBoundingBoxSurface(SDL_Surface* sa, int ax, int ay, SDL_Surface* sb, int bx, int by)
{
  if (bx + sb->w < ax)
    return 0; // just checking if their
  if (bx > ax + sa->w)
    return 0; // bounding boxes even touch
...
*/
int
SDL_CollideBoundingBox(SDL_Rect a, SDL_Rect b)
{
  if (b.x + b.w < a.x)
    return 0; // just checking if their
  if (b.x > a.x + a.w)
...
*/
int
SDL_CollideBoundingCircle(int x1, int y1, int r1, int x2, int y2, int r2, int offset)
{
...
*/
int
SDL_CollideBoundingCircleSurface(SDL_Surface* a, int x1, int y1, SDL_Surface* b, int x2, int y2, int offset)
{
  int r1 = 0;
  int r2 = 0;
